class RecipeCard {
    ...
    getReceipeCard() {
        ...
        imgContainer.setAttribute("class", "relative h-[150px] md:h-[250px] w-[100%] overflow-hidden");
        ...
        timerContainer.setAttribute("class", "absolute flex top-[20px] right-[30px] rounded-[10px] bg-[#FFD15B] p-[8px] text-[0.8em] md:p-[10px] md:text-[1.0em]");
        timerContainer.textContent = this._recipe.time + " min";

        const recipeContainer = document.createElement( "div" );
        recipeContainer.setAttribute("class", "flex flex-col items-center lg:items-start mx-[20px] h-[75%]");

        const recipeTitle = document.createElement( "h2" );
        recipeTitle.setAttribute("class", "font-['Anton'] font-bold text-[1em] md:text-[1.3em] mt-[25px] mb-[35px]");
        recipeTitle.textContent = this._recipe.name;

        const recipeDescription = document.createElement( "div" );
        recipeDescription.setAttribute("class", "font-['Manrope'] text-[0.7em] md:text-[0.9em]");
        ...
        description.setAttribute("class", "mt-[15px] mb-[35px] text-[0.9em] md:text-[1.0em]");
        ...
        gridDetailsContainer.setAttribute("class", "grid grid-cols-2 my-[15px] gap-5 text-[0.9em] md:text-[1.0em]");
